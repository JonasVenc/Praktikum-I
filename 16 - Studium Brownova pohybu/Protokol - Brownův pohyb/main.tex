...
\includegraphics[scale=0.9,page=1]{16 - Studium Brownova pohybu/Protokol - Brownův pohyb/Brown8.pdf}

\includegraphics[scale=0.9,page=2]{16 - Studium Brownova pohybu/Protokol - Brownův pohyb/Brown8.pdf}

\begin{figure}[h]
    \centering
    \includegraphics[width=1\linewidth]{16 - Studium Brownova pohybu//Protokol - Brownův pohyb//img/Castice.jpg}
\end{figure}
% ----------------------------------------------------------------------
